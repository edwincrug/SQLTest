CREATE PROCEDURE [tipoobjeto].[SEL_TIPOOBJETO_ENCABEZADO_SP]  
 @idObjeto   INT = 0,  
...
BEGIN  
 ...
 set @query = '  
  select  
   *,  
   [tipoobjeto].[SEL_TIPOOBJETO_NOMBRE_FN]('+ CAST(@idObjeto AS VARCHAR(50)) +',''+ CAST(@agrupador AS VARCHAR(50)) +'',''+ CAST(@idClase AS VARCHAR(50)) +'') AS [NombreCompleto]  
  from  
